...
REQUIRED_OVERLAPS = {
    ...
    frozenset(("blender-game-asset-artist", "godot-game-creation-engineer")),
    frozenset(("blender-game-asset-artist", "godot-level-designer")),
    frozenset(("gameplay-consultant", "godot-game-creation-engineer")),
    frozenset(("gameplay-consultant", "godot-level-designer")),
    frozenset(("gameplay-consultant", "godot-quest-designer")),
    frozenset(("godot-game-creation-engineer", "godot-level-designer")),
    frozenset(("godot-game-creation-engineer", "godot-quest-designer")),
    frozenset(("godot-level-designer", "godot-quest-designer")),
