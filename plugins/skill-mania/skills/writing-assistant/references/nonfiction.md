...
- the transformation or insight promised
...
- anecdotes have a point beyond color
- terms are defined before heavy use
- counterarguments are treated honestly
...
- one job
- a reader-relevant opening
- a clear argument or lesson
...
- exercises are concrete enough to perform
